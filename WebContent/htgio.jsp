		...
		<tr>
			<td valign="top" width="200">
				<table class="table table-hover">
					...
					%>
					<tr>
						<td><a href="menu.jsp?ml=<%=l.getMaloai()%>"> <%=l.getTenloai()%>
						</a></td>
					</tr>
					<%
					}
			...
			<td valign="top" width="800">
				...
				<table class="table table-hover">
					...
					<tr>
						...
						<td><a href="xoasua.jsp?ms=<%=g.getMasach()%>"> <i
...
<%
			...
			<td>
				<form action="menu.jsp" method="post" class="search"
					style="display: flex; align-items: center;">
					<input type="text" name="txttk" class="form-control"><br>
					<input type='submit' name='th' value='Search' class="btn-success">
