...
/**
 * Servlet implementation class BangtinhController
 */
@WebServlet("/BangtinhController")
public class BangtinhController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("Bangtinh.jsp");
